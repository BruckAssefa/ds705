...
```
At a .05 significance, it is plausible that both the treated (p-value 0.6504) and the untreated (p-value 0.5491) came from a normal distribution.
...
```
At .05 significance, we fail to reject the null hypothesis (p-value 0.7104). In other words, it is entirely plausible that the variables are equal.
---
...
At a .05 significance, we are able to reject the null hypothesis. That is to say, there is sufficent evidence to claim that the population mean of worms in sheep for the treated group is different than the population mean of worms in sheep for the untreated group.
...
It appears as though the students with a prior course is from a normal distribution(p-value 0.6362). It is less clear whether the students who were self-taught is from a normal distribution (p-value 0.1025) However, I am willing to accept that it was using a signifance of 0.5.
...
At a .05 signifance, we are able to reject the null hypothesis. That is to say, the population mean of all students words per minute typed for prior course students is different than the population mean of all students words per minute typed for self-taught students.
